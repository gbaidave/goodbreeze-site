  ...
  return (
    <div className="min-h-screen bg-dark py-24 px-6">
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        >
          <Link href={isAuthenticated ? '/support' : '/'} className="text-gray-500 hover:text-primary text-sm transition-colors">
            ← {isAuthenticated ? 'Support requests' : 'Back to Home'}
          </Link>
        ...
        >
          ...
          {/* Bug report tips — shown only when category is bug_report */}
          {category === 'bug_report' && (
            <BugReportGuide />
          )}
