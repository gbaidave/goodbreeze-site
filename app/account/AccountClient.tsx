                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-800/60">
                    ...
                    {([
                      ...
                      { key: 'support_emails',      label: 'Support updates',       desc: 'When a support or contact form request gets a reply, is resolved, or closed.', email: supportEmails,       setEmail: setSupportEmails,       push: pushSupportEmails,       setPush: setPushSupportEmails },
                      { key: 'support_confirmation',label: 'Request confirmation',  desc: 'Confirmation when you submit a support or contact form request.',              email: supportConfirmation, setEmail: setSupportConfirmation, push: pushSupportConfirmation, setPush: setPushSupportConfirmation },
