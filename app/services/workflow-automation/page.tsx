        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-dark-700 rounded-xl border border-primary/20 p-6">
              ...
              <p className="text-gray-300">Automatically capture, route, and follow up with leads from multiple sources without manual data entry.</p>
            </div>

            <div className="bg-dark-700 rounded-xl border border-primary/20 p-6">
              <h3 className="text-lg font-semibold text-primary mb-2">Client Onboarding</h3>
              <p className="text-gray-300">Streamline new client intake with automated document collection, welcome sequences, and task assignments.</p>
            </div>

            <div className="bg-dark-700 rounded-xl border border-primary/20 p-6">
              <h3 className="text-lg font-semibold text-primary mb-2">Reporting & Analytics</h3>
              <p className="text-gray-300">Generate and distribute reports automatically on a schedule you define—daily, weekly, or monthly.</p>
            </div>

            <div className="bg-dark-700 rounded-xl border border-primary/20 p-6">
              <h3 className="text-lg font-semibold text-primary mb-2">Data Synchronization</h3>
              <p className="text-gray-300">Keep your CRM, accounting software, and other tools in sync without manual updates or imports.</p>
            </div>
          </div>
        </div>
