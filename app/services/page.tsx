...
const services = [
  ...
  },
  {
    ...
    description: "Your business isn't off-the-shelf, and your automation shouldn't be either. Bespoke solutions built exactly for your processes, your tools, your way of working.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
