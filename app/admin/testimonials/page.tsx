              ...
              <div key={t.id} className="bg-dark-700 border border-primary/20 rounded-2xl p-6 space-y-3">
                ...
                {t.video_url && (
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary/15 border border-primary/40 text-primary text-sm font-medium rounded-lg hover:bg-primary/25 transition-colors"
                  >
