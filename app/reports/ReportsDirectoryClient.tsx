...
export interface ReportsDirectoryProps {
  bprCreditCost: number      // from products catalog business_presence_report row (price_credits)
  minPlanPrice: string       // cheapest active subscription plan, e.g. "$20"
  minPlanCredits: number     // credits at that price, e.g. 25
}
...
export default function ReportsDirectoryClient({ bprCreditCost, minPlanPrice, minPlanCredits }: ReportsDirectoryProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-2.5 flex-shrink-0">
            ...
            <p className="text-[11px] text-gray-600"><span className="text-primary font-semibold">First report free.</span> Updates cost {bprCreditCost} credits.</p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Monthly plans start at {minPlanPrice}/month for {minPlanCredits} reports across all types. Or grab a credit pack for occasional use.
          </p>
          <Link
            href="/pricing"
