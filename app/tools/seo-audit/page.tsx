  ...
  return (
    <div className="min-h-screen bg-dark flex items-center justify-center px-6">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <h2 className="text-2xl font-bold text-white mb-3">Audit running!</h2>
        <p className="text-gray-400 mb-2">Your SEO audit is underway. The PDF will arrive in your inbox within <strong className="text-white">3–5 minutes</strong>.</p>
...
export default function SeoAuditPage() {
  ...
  useEffect(() => {
    if (!authLoading && !user) router.push('/login?redirectTo=/tools/seo-audit')
