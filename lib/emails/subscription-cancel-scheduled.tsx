export function subscriptionCancelScheduledEmail(data: {
  userName: string
  planLabel: string
  ...
  return {
    subject: `Your ${planLabel} cancellation is scheduled`,
    html: `<!DOCTYPE html>
<html>
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background:#18181b;border:1px solid #27272a;border-radius:16px;padding:40px;">
          <h1 style="margin:0 0 12px;font-size:24px;font-weight:700;color:#ffffff;">Cancellation scheduled</h1>
          <p style="margin:0 0 20px;font-size:16px;color:#a1a1aa;line-height:1.6;">
            Hi ${firstName}, we've scheduled your ${planLabel} cancellation. You'll keep full access until the end of your current billing period.
          </p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;background:#09090b;border:1px solid #27272a;border-radius:10px;padding:16px;">
            ...
            <tr>
              <td style="font-size:13px;color:#71717a;vertical-align:top;">Access ends</td>
              <td style="font-size:13px;color:#ffffff;">${periodEndDate}</td>
            </tr>
          </table>

          <p style="margin:0 0 24px;font-size:15px;color:#a1a1aa;line-height:1.6;">
            Changed your mind? You can restart your plan anytime before ${periodEndDate} and nothing will be interrupted.
          </p>
