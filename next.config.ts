    ...
    const securityHeaders = [
      ...
      // Note: 'unsafe-inline' needed for Framer Motion inline styles + GTM; tighten post-launch
      {
        ...
        value: [
          ...
          `connect-src 'self' ${supabaseUrl} https://www.google-analytics.com https://api.stripe.com https://internal.goodbreeze.ai https://us.i.posthog.com https://us-assets.i.posthog.com https://app.posthog.com https://www.googleapis.com${isStaging ? ' https://vercel.live' : ''}`,
